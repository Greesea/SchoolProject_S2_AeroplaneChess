...
function Initialize() {
    ...
    mainMenuArray[1] = new MenuButton(null, new Location(60, 280), 1, new Size(150, 150), "单人游戏", "20pt 微软雅黑", new Location(22, 83), "red", "white", Functions.AreaCheck, Functions.DrawMenuButton, null, controlsOnClick, controlsOnMouseDown, controlsOnHover, controlsOnLeave);
