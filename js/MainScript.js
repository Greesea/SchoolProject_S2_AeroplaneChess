...
function Initialize() {
    ...
    var routeArray = [];
    routeArray.push(new GameRouteNote(null, new Location(50, 50), Region.Orange, false, false));
    routeArray.push(new GameRouteNote(null, new Location(100, 50), Region.Orange, true, false));
    routeArray.push(new GameRouteNote(null, new Location(150, 50), Region.Orange, false, false));
    routeArray.push(new GameRouteNote(null, new Location(200, 50), Region.Orange, false, false));
    routeArray.push(new GameRouteNote(null, new Location(250, 50), Region.Orange, false, false));
    routeArray.push(new GameRouteNote(null, new Location(300, 50), Region.Orange, false, false));

    var goalArray = [];
    goalArray.push(new GameGoalPath(null, [new Location(50, 100), new Location(100, 100)], Region.Blue));

    var pairArray = [];
    pairArray.push(new GameTunnelPair(routeArray[1], routeArray[4], goalArray[0], 1));

    var hangerNodeArray = [];
    hangerNodeArray.push(new GameHangarNode(null, new Location(0, 0)));

    var hanger = new GameHangar(null, new Location(0, 0), Region.Orange, hangerNodeArray);
